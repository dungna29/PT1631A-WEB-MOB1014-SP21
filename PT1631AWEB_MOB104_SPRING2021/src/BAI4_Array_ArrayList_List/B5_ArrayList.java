...
public class B5_ArrayList {
    ...
    public static void main(String[] args) {
        ...
        ArrayList arrLstKhongDinhKieu;
        arrLstKhongDinhKieu = new ArrayList();
        ArrayList arrLstKhongDinhKieu1 = new ArrayList();
        ...
        ArrayList<Long> arrLstLong = new ArrayList<Long>();
        ...
        //double diem = arrLstKhongDinhKieu.get(1); 
