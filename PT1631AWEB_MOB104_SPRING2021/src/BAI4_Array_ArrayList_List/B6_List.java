...
public class B6_List {
    ...
    public static void main(String[] args) {
       //1. Khởi tạo List không định kiểu và có định kiểu
        ...
        List lstKhongDinhKieu;
        lstKhongDinhKieu = new ArrayList();
        List lstKhongDinhKieu1 = new ArrayList();
        ...
        List<Float> lstFloat = new ArrayList<Float>();
        ...
        System.out.println(lstKhongDinhKieu.isEmpty());
