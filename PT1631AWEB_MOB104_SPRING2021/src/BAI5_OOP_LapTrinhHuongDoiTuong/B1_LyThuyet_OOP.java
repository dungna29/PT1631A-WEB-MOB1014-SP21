...
public class B1_LyThuyet_OOP {
    ...
    public static void main(String[] args) {
        //Khai báo Thông tin 1 sinh viên
        ...
        //Khai báo chó
        String tenCho, diachiCho;
        int namsinhCho;

        //1. Khởi tạo 1 đối tượng
        String temp;
        SinhVien sv1 = new SinhVien();//Tạo ra 1 đối tượng lưu trữ 1 sinh viên
        SinhVien sv2;//Tạo ra 1 đối tượng lưu trữ 1 sinh viên
        sv2 = new SinhVien();
        ...
        //4. Sử dụng phương thức của đối tượng
        sv1.inRaManHinh();
        sv2.inRaManHinh();
